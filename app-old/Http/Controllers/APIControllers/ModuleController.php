 ...
 public function citiesListing(){
    ...
    public function getinTouch(Request $request){
       ...
       $validator = \Validator::make(request()->all(), [
              ...
              'type' => 'required|in:Complain,GeneralInquiry',
    ...
    public function aboutUs(){
        ...
        $link = 'http://128.199.31.19/mdc/api/about';
   ...
   public function termsServices(){
       ...
       $link = 'http://128.199.31.19/mdc/public/api/terms/services';
   ...
   public function privacyPolicy(){
       ...
       $link = 'http://128.199.31.19/mdc/public/api/policy';
