...
@endif
 ...
 <div class="card-deck row" style="padding: 10px;text-align: start">
...
<a href="{{ URL::previous()  }}" class="btn bg-navy submitdata float-right" type="submit" style="margin-left:9px;margin-top: 16%;"><i class="fa fa-angle-double-left"></i></a>
