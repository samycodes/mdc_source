      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <a href="#" class="nav-link @if(Request::segment(1) == 'banner' && Request::segment(2) == 'listing' || Request::segment(1) == 'banner' && Request::segment(2) == 'add') active @endif">
              <i class="nav-icon nav-icon fas fa-sliders-h"></i>
              <p>
                Banner
                <i class="right fas fa-angle-left"></i>
              </p>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ route('banner.add') }}" class="nav-link @if(Request::segment(1) == 'banner' && Request::segment(2) == 'add') active @endif">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Banner</p>
                </a>
              </li>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ route('banner.index') }}" class="nav-link inactive">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Listing</p>
                </a>
              </li>
        ...
        <li class="nav-item has-treeview">
            <a href="#" class="nav-link @if(Request::segment(1) == 'getin' && Request::segment(2) == 'touch')  active @endif">
              <i class="nav-icon nav-icon  fa fa-address-book-o" style="font-size: 20px;"></i>
              <p>
               Get In Touch
                <i class="right fas fa-angle-left"></i>
              </p>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ route('contact.index') }}" class="nav-link @if(Request::segment(1) == 'condition' && Request::segment(2) == 'view') active @endif">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View</p>
                </a>
              </li>
