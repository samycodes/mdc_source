...
<div class="card">
              <div class="card-header">
                <h3 class="card-title">Offer Listing</h3>
                 <a href="{{ route('offer.add') }}" class="btn bg-navy submitdata float-right"  id="submitdata" type="submit"><i class="fa fa-plus"></i></a>
                ...
                <table id="example1" class="table table-bordered example1">
                   <thead>
                    <tr>
                      ...
                      <th>Offer Image</th>
                      <th data-orderable="false">Offer Enable/Disable</th>
                      <th data-orderable="false">Offer Action</th>
    ...
    jQuery('.delete').on('click',function()
    {
        ...
        .then((willDelete) => {
          if (willDelete) {
            ...
            swal("Offer delete successfully",
            {
              icon: "success",
            });
          } 
