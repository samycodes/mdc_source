							...
							<table style="font-weight: normal;border-collapse: collapse;border: 0;margin: 0;padding: 0;font-family: Arial, sans-serif;">
								<tr>
									<td class="head-title" style="border-collapse: collapse;border: 0;margin: 0;padding: 0;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 28px;line-height: 34px;font-weight: bold; text-align: center;">
										<div class="mktEditable" id="main_title" style="
    font-size: larger;
    font-weight: 700;
">
								...
								<tr>
									...
									<img class="top-image" src="http://webapps.iqlance-demo.com/mdc/public/favicon_io/android-chrome-filter.png" width="400"/><br><br>
								...
								<tr>
									...
									<div class="mktEditable" id="main_text">
										 Hey {{ $data->fullname }},<br><br>

										Welcome to our MDC App. It's great to meet you !<br />
                                            
                                           We're excited to have you get started. We promise to keep you up-to-date with You.<br><br>
                                           Thank You
									</div>
									</td>
								</tr>
