                        ...
                        <div class="row no-gutters">
                            <div class="col-sm-6 col-lg-5 col-xxl-3  align-self-center order-2 order-sm-1">
                                <div class="d-flex align-items-center h-100-vh" >
                                    ...
                                    <div class="navbar-header d-flex align-items-center">
                                        ...
                                        <img src="{{ URL::asset('public/favicon_io/apple-touch-icon.png') }}" style="width: 80px;height: 100% !important;" class="img-fluid logo-desktop" alt="logo" />
                            ...
                            <div class="col-sm-12 col-xxl-9 col-lg-7 bg-gradient o-hidden order-1 order-sm-2">
                                ...
                                <div class="row align-items-center h-100" style="background: linear-gradient(to right,#e2f5fc 0,#e0f4fcf5 100%)!important;">
                                    <div class="">
                                        <img class="" src="{{URL::asset('public/images/O6RBXH0.jpg') }}" alt="" style="height: 656px;width: 100%;padding: -10px;margin-left: 17%;">
                                    </div>
                                </div>
