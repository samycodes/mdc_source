...
Route::post('/notification/testing', 'APIControllers\HomeController@notificationTesting');

Route::post('/notification/all', 'AdminControllers\HospitalController@alluserNotification');
