...
<div class="card card-statistics">
    <div class="card-header">
        <div class="card-heading">
            <h4 class="card-title">Edit Policy Content</h4>
        </div>
    </div>
    <div class="card-body">
        ...
        <div class="col-md-12">
          <div class="card card-outline card-info" style="border-top: 3px solid #001f3f;">
            ...
            <div class="card-body pad">
              <div class="mb-3">
                <textarea class="textarea" name="description" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ $data->description }}</textarea>
              </div>
...
$(document).on('submit', '.contactForm', function(e) {
        ...
        success : function(response)
        {
          ...
          if (response.success) {
              ...
              $.toaster({ priority : 'success', title : 'Success', message : 'Update Policy Successfully'});
              window.location = '/mdc/policy/view';
