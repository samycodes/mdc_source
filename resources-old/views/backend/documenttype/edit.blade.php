    ...
    <div class="card-body">
         ...
         <form class="mt-3 contactForm" enctype="multipart/form-data" id="contactForm">
          ...
          <!--@csrf-->
                ...
                <input type="hidden" value="{{ $documenttype->id }}" id="dataid">
            <div class="form-row">
                <div class="col-md-12">
                    <label >Document Type</label>

                    <input type="text" name="name" autocomplete="off" class="form-control @if($errors->has('title')) is-invalid @endif"  value="{{ $documenttype->name }}"
...
<script>
    $(document).ready(function(){
      var id = $('#dataid').val();
      var postURL = "/mdc/documenttype/update/" + id;
      var i=1;
      var limit = 5;
    ...
    $(document).on('submit', '.contactForm', function(e) {
     ...
     $.ajax({
        url: "/mdc/documenttype/update/" + id,
        ...
        success : function(response)
        {
           if (response.success) {
              ...
              $.toaster({ priority : 'Success', title : 'Success', message : 'Document Type Update Successfully'});
