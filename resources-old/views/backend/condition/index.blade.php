...
<head>
  ...
  <title>MDC Terms & Condition</title>
...
<a href="{{ route('condition.edit') }}" type="button" class="btn  float-right bg-navy"><i class="fa fa-edit"></i></a>
        ...
        <tr>
          ...
          <!-- body -->
                  <table border="0" cellpadding="0" cellspacing="0" width="740" class="fullwidth" align="center"
                         style="margin:auto">
                    <tr>
                      <td style="" class="avenir padded" ap:edit="body">
                        <p><b>{{ $data->title }}</b></p>
