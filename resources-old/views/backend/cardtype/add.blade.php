...
<div class="card card-statistics">
    ...
    <div class="card-header">
        <div class="card-heading">
            <h4 class="card-title">Add New Card Type</h4>
        </div>
          ...
          @csrf
            ...
            <div class="form-row">
                <div class="col-md-12">
                    ...
                    <input type="text"  maxlength="6" name="price"  onkeypress="return isNumber(event)" class="form-control @if($errors->has('title')) is-invalid @endif"  value="{{ old('title')}}"
     ...
     $.ajax({
        ...
        success : function(response)
        {
           if (response.success) {
              ...
              $.toaster({ priority : 'Success', title : 'Success', message : 'New card type Added Successfully'});
