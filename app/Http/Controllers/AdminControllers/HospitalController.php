...
class HospitalController extends Controller
{
    public function alluserNotification(){
        ...
        $noti['mdesc'] = 'Notification Test';
        $noti['mtitle'] = 'Notification Test';
        if(!empty($result)){
    ...
    public function pushNotification($noti)
    {
    ...
    public function save(Request $request){
           ...
           try {
            ...
            $noti['mdesc'] = 'New Hospital  ' . $hospital->name . '  & Hospital Service Added.';
